      ...
      <div className="flex flex-col pt-4">
        <div className="flex items-center space-x-2">
          ...
          <div className="flex flex-row space-x-0.5 items-center">
            ...
            <h1 className="text-3xl font-medium p-2">InsightFlow Settings</h1>
          </div>
        </div>
      ...
      <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
        <div className="flex items-center">
          <div className="text-sm text-blue-800 dark:text-blue-300">
            <p className="font-medium">InsightFlow v{config?.version || '1.0.0'}</p>
            <p>Created by {config?.creator || 'Aniket Kumar'}</p>
            <p className="mt-2 text-xs">Powered by Cerebras Llama 3.3 70B</p>
          </div>
        </div>
      </div>
