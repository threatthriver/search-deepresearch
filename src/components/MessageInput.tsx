...
const MessageInput = ({
  ...
  return (
    <form
      ...
      className={cn(
        'bg-light-secondary dark:bg-dark-secondary p-4 flex items-center overflow-hidden border border-light-200 dark:border-dark-200 shadow-sm',
    ...
    >
      ...
      <TextareaAutosize
        ...
        placeholder={chatModelProvider === 'cerebras' ? 'Ask Llama 3.3 anything...' : 'Ask a follow-up'}
      />
      {mode === 'single' && (
        <div className="flex flex-row items-center space-x-4">
          ...
          >
            {loading ? (
              <div className="h-[17px] w-[17px] rounded-full border-2 border-t-transparent border-white animate-spin" />
            ) : (
